...
export const DamiatCalculatorForm: React.FC<DamiatCalculatorFormProps> = ({
  ...
  const defaultBasePrice = useMemo(() => defaultSeptemberPricePerTon(crop), [crop]);
  ...
  const pricePreview = useMemo(() => {
    ...
    return buildPriceForecast(crop, values.priceAdjustPercent, manualBase);
  }, [crop, values.manualBasePricePerTon, values.priceAdjustPercent]);
            ...
            <div className="grid grid-cols-2 gap-[var(--space-12)]">
              ...
              <div className="min-w-0">
                ...
                <Input
                  size="lg"
                  fullWidth
                  placeholder={String(crop.defaultYieldTonsPerHa)}
