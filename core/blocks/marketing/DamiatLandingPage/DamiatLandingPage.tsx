...
import { ScrollLoopBridge } from '../../_shared/ScrollLoopBridge';
...
export const DamiatLandingScrollBody: React.FC<DamiatLandingScrollBodyProps> = ({
  ...
  const heroImageParallax = scrollLoop ? 0.08 : 0.14;
  const heroParallaxFactors = scrollLoop
    ? { copyParallaxFactor: 0.03, mediaParallaxFactor: 0.05, metricsParallaxFactor: 0.02 }
    : undefined;
  ...
  return (
    <>
      <MarketingAboveFold
        ...
        imageParallaxFactor={heroImageParallax}
      ...
      <BrandPhotoHeroSection
        ...
        contentParallaxFactor={0.03}
      >
        <ScrollDepthReveal intensity="subtle" staggerChildren>
          <ContactHeroBlock {...contactHero} embeddedInPhotoHero />
      ...
      {scrollLoop ? (
        <ScrollLoopBridge
          wordmark={DAMIAT_LOOP_BRIDGE_WORDMARK}
